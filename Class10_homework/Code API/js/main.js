	...
	$(document).ready(function(){
		...
		$("#btn").click(function(){
			...
			$.getJSON("https://api.coindesk.com/v1/bpi/currentprice.json", function(data){
				...
				$(".json-container").append(data.time.updated + "<br>"+ "<br>");
				$(".json-container").append(data.disclaimer + "<br>"+ "<br>");
				$(".json-container").append(data.bpi.USD.rate + "<br>"+ "<br>");
				$(".json-container").append(data.bpi.USD.description + "<br>"+ "<br>");
...
*/
	...
	// 		// console.log("clicked");
	//
	// 		$.getJSON("https://api.carbonintensity.org.uk/intensity", function(data){
	//
	// 			console.log(data);
	//
	...
	//
	// 				$(".json-container").append(key.from + '<br>' + key.to  + '<br>' + '<br>');
	//
	//
	// 			});
	//
